...
# Gali list (can be customized)
bad_words = ['gandu', 'choda', 'bokachoda', 'madarchod', 'fuck', 'shit', 'banchod', 'চোদা', 'মাদারচোদ', 'চুদি', 'g***']

# Witty Bangla replies
witty_replies = [
...
# Setup
app = ApplicationBuilder().token("7911220246:AAFGx9yAhrEGGTd8r6o4N8U0uFqpQ87y2a4").build()
